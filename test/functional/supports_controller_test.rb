...
class SupportsControllerTest < ActionController::TestCase
  ...
  test "should create support" do
    assert_difference('Support.count') do
      post :create, support: { support_request: @support.support_request, user_email: @support.user_email, user_name: @support.user_name }
    end
  ...
  test "should update support" do
    put :update, id: @support, support: { support_request: @support.support_request, user_email: @support.user_email, user_name: @support.user_name }
    assert_redirected_to support_path(assigns(:support))
  end
